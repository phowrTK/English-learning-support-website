              ...
              <div class="p-5">
                ...
                <form class="user" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control form-control-user" name="address" id="exampleRepeatPassword" placeholder="Address">
                    </div>
                  </div>
                  <input style="margin-left: 200px" type='submit' value='Save' name="submit" class='btn btn-primary' />
                  <a href='admin/listadmin.php' class='btn btn-danger'>Listadmin</a> 
