    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="block-2 red">
          ...
          <h2>Khóa Học</h2>
          <p>Ở đây. Có tất cả mọi tài liệu học tiếng anh dành cho tất cả mọi lứa tuổi.Có các level khác nhau từ cơ bản đến nâng cao phù hợp với mọi người. Những khóa học online giúp bạn tiết kiệm thời gian và tiền bạc.</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="block-2 yellow">
          ...
          <h2>Kỹ Năng</h2>
          <p>Tài liệu giúp nâng cao kỹ năng giao tiếp tiếng Anh.Cải thiện giao tiếp giúp bạn tự tin hơi khi giao tiếp băng Tiếng Anh. Còn đợi gì nữa, hãy lựa chọn level phù hợp với bản thân mình và trải nghiệm.</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="block-2 teal">
          ...
          <h2>Ngữ Pháp</h2>
          <p>Tại đây có tất cả các thì từ cơ bản đến nâng cao mà người học tiếng Anh cần trang bị cho bản thân.Trạng từ, động từ khiếm khuyết cần thiết cho bạn sử dụng trong mọi trường hợp.</p>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="package text-center bg-white">
          ...
          <h3 class="text-teal">Course - Khóa Học</h3>
          <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p>
          <p><a href="course.php" class="btn btn-primary btn-custom-1 mt-4">Learn More</a></p>
        </div>
      </div>
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="package text-center bg-white">
          <span class="img-wrap"><img src="images/flaticon/svg/002-target.svg" alt="Image" class="img-fluid"></span>
          <h3 class="text-success">Kỹ Năng</h3>
          <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p>
          <p><a href="skill.php" class="btn btn-warning btn-custom-1 mt-4">Learn More</a></p>
        </div>
      </div>
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="package text-center bg-white">
          <span class="img-wrap"><img src="images/flaticon/svg/003-mission.svg" alt="Image" class="img-fluid"></span>
          <h3 class="text-danger">Ngữ Pháp</h3>
          <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p>
          <p><a href="grammar.php" class="btn btn-success btn-custom-1 mt-4">Learn More</a></p>
        </div>
      </div>
    </div>
  </div>
